...
export default function BurgerRecipe() {
  return (
    <>
      <Stack.Screen 
        options={{
      ...
      <ScrollView style={styles.container}>
        <View style={styles.gradientBackground}>
          <View style={styles.recipeHeader}>
            <Text style={styles.title}>Classic Burger</Text>
            <View style={styles.infoContainer}>
              ...
              <View style={styles.infoItem}>
                ...
                <Text style={styles.infoValue}>550 kcal</Text>
              </View>
              <View style={styles.infoItem}>
          ...
          <View style={styles.imageContainer}>
            <Image 
              source={require('../../assets/recipes/burger.png')}
          ...
          <View style={styles.section}>
            ...
            <View style={styles.instructionsList}>
              {[
                'Form the ground beef into 4 equal patties, about 1/2 inch thick.',
                'Season both sides of each patty with salt and pepper.',
                'Heat oil in a large skillet or grill pan over medium-high heat.',
                'Cook the patties for 4-5 minutes on each side for medium-rare, or longer for desired doneness.',
                'Add cheese slices to the patties during the last minute of cooking.',
                'Toast the hamburger buns on the grill or in a toaster.',
                'Assemble the burgers with lettuce, tomato, onion, and pickles.'
          ...
          <View style={styles.nutritionSection}>
            ...
            <View style={styles.nutritionContent}>
              <View style={styles.calorieBox}>
                <Text style={styles.calorieNumber}>550</Text>
                ...
                <View style={styles.nutritionRow}>
                  <View style={styles.macroItem}>
                    ...
                    <View style={styles.macroTextContainer}>
                      ...
                      <Text style={styles.macroValue}>25g</Text>
                    </View>
                  </View>
                  <View style={styles.macroItem}>
                    <View style={styles.macroIconContainer}>
