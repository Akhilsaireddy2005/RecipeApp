...
export default function TomatoCurryRecipe() {
  return (
    <>
      <Stack.Screen 
        options={{
      ...
      <ScrollView style={styles.container}>
        <View style={styles.gradientBackground}>
          <View style={styles.recipeHeader}>
            <Text style={styles.title}>Tomato Curry</Text>
            <View style={styles.infoContainer}>
              ...
              <View style={styles.infoItem}>
                ...
                <Text style={styles.infoValue}>150 kcal</Text>
              </View>
              <View style={styles.infoItem}>
          ...
          <View style={styles.imageContainer}>
            <Image 
              source={require('../../assets/recipes/tomato-curry.png')}
          ...
          <View style={styles.section}>
            ...
            <View style={styles.instructionsList}>
              {[
                ...
                'Add chopped tomatoes, green chilies, turmeric, and red chili powder.',
                'Cover and cook on low heat for 15 minutes, stirring occasionally.',
                'Mash the tomatoes slightly with a spoon and cook uncovered for 5-7 minutes.',
          ...
          <View style={styles.nutritionSection}>
            ...
            <View style={styles.nutritionContent}>
              <View style={styles.calorieBox}>
                <Text style={styles.calorieNumber}>150</Text>
                ...
                <View style={styles.nutritionRow}>
                  ...
                  <View style={styles.macroItem}>
                    ...
                    <View style={styles.macroTextContainer}>
                      ...
                      <Text style={styles.macroValue}>3g</Text>
                    </View>
                  </View>
                </View>
