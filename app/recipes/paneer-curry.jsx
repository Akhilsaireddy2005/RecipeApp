...
export default function PaneerCurryRecipe() {
  return (
    <>
      <Stack.Screen 
        options={{
      ...
      <ScrollView style={styles.container}>
        <View style={styles.gradientBackground}>
          <View style={styles.recipeHeader}>
            <Text style={styles.title}>Paneer Curry</Text>
          ...
          <View style={styles.imageContainer}>
            <Image 
              source={require('../../assets/recipes/paneer.png')}
          ...
          <View style={styles.section}>
            ...
            <View style={styles.instructionsList}>
              {[
                'Cut the paneer into medium-sized cubes and set aside.',
                ...
                'Carefully add paneer cubes and cook for 5-7 minutes until heated through.',
                ...
                <View style={styles.nutritionRow}>
                  <View style={styles.macroItem}>
                    ...
                    <View style={styles.macroTextContainer}>
                      ...
                      <Text style={styles.macroValue}>24g</Text>
                    </View>
                  </View>
                  <View style={styles.macroItem}>
                    <View style={styles.macroIconContainer}>
