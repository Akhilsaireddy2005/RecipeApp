...
export default function PotatoCurryRecipe() {
  return (
    <>
      <Stack.Screen 
        options={{
      ...
      <ScrollView style={styles.container}>
        <View style={styles.gradientBackground}>
          <View style={styles.recipeHeader}>
            <Text style={styles.title}>Potato Curry</Text>
            <View style={styles.infoContainer}>
              ...
              <View style={styles.infoItem}>
                ...
                <Text style={styles.infoValue}>245 kcal</Text>
              </View>
              <View style={styles.infoItem}>
          ...
          <View style={styles.imageContainer}>
            <Image 
              source={require('../../assets/recipes/potato-curry.png')}
          ...
          <View style={styles.section}>
            ...
            <View style={styles.instructionsList}>
              {[
                ...
                'Add potatoes and water, simmer until potatoes are tender.',
          ...
          <View style={styles.nutritionSection}>
            ...
            <View style={styles.nutritionContent}>
              <View style={styles.calorieBox}>
                <Text style={styles.calorieNumber}>245</Text>
