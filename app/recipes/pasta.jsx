...
export default function PastaRecipe() {
  return (
    <>
      <Stack.Screen 
        options={{
      ...
      <ScrollView style={styles.container}>
        <View style={styles.gradientBackground}>
          <View style={styles.recipeHeader}>
            <Text style={styles.title}>Classic Pasta</Text>
            <View style={styles.infoContainer}>
              ...
              <View style={styles.infoItem}>
                ...
                <Text style={styles.infoValue}>420 kcal</Text>
              </View>
              <View style={styles.infoItem}>
          ...
          <View style={styles.imageContainer}>
            <Image 
              source={require('../../assets/recipes/pasta.png')}
          ...
          <View style={styles.nutritionSection}>
            ...
            <View style={styles.nutritionContent}>
              <View style={styles.calorieBox}>
                <Text style={styles.calorieNumber}>420</Text>
                ...
                <View style={styles.nutritionRow}>
                  ...
                  <View style={styles.macroItem}>
                    ...
                    <View style={styles.macroTextContainer}>
                      ...
                      <Text style={styles.macroValue}>14g</Text>
                    </View>
                  </View>
                </View>
