...
export default function PulaoRecipe() {
  return (
    <>
      <Stack.Screen 
        options={{
      ...
      <ScrollView style={styles.container}>
        <View style={styles.gradientBackground}>
          <View style={styles.recipeHeader}>
            <Text style={styles.title}>Pulao</Text>
          ...
          <View style={styles.imageContainer}>
            <Image 
              source={require('../../assets/recipes/pulao.png')}
          ...
          <View style={styles.section}>
            ...
            <View style={styles.instructionsList}>
              {[
                ...
                'Heat ghee/oil in a large pan and add whole spices (cardamom, cloves, cinnamon, bay leaves).',
                'Add cumin seeds and let them splutter.',
                'Add onions and sauté until golden brown.',
                'Add ginger-garlic paste and sauté for a minute.',
                'Add vegetables and cook for 2-3 minutes.',
                'Add drained rice and salt, mix well.',
