...
export default function ChickenBiryaniRecipe() {
  return (
    <ScrollView style={styles.container}>
      <View style={styles.gradientBackground}>
        <View style={styles.recipeHeader}>
          ...
          <View style={styles.infoContainer}>
            ...
            <View style={styles.infoItem}>
              ...
              <Text style={styles.infoValue}>650 kcal</Text>
            </View>
            <View style={styles.infoItem}>
        ...
        <View style={styles.imageContainer}>
          <Image 
            source={require('../../assets/recipes/biryani.png')}
        ...
        <View style={styles.section}>
          ...
          <View style={styles.instructionsList}>
            {[
              ...
              'In a large pot, fry sliced onions until golden brown. Remove half for garnishing.',
              'Add marinated chicken to the same pot and cook until tender.',
              'Layer half of the rice, add chicken masala, then add remaining rice.',
              'Pour saffron milk on top. Garnish with fried onions and herbs.',
              'Cover with tight lid and cook on low heat (dum) for 20 minutes.',
        ...
        <View style={styles.nutritionSection}>
          ...
          <View style={styles.nutritionContent}>
            <View style={styles.calorieBox}>
              <Text style={styles.calorieNumber}>650</Text>
              ...
              <View style={styles.nutritionRow}>
                <View style={styles.macroItem}>
                  ...
                  <View style={styles.macroTextContainer}>
                    ...
                    <Text style={styles.macroValue}>22g</Text>
                  </View>
                </View>
                <View style={styles.macroItem}>
                  <View style={styles.macroIconContainer}>
                  ...
                  <View style={styles.macroTextContainer}>
                    ...
                    <Text style={styles.macroValue}>6</Text>
                  </View>
                </View>
              </View>
            </View>
