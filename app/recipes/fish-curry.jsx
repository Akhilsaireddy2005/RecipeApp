      ...
      <ScrollView style={styles.container}>
        <View style={styles.gradientBackground}>
          <View style={styles.recipeHeader}>
            ...
            <View style={styles.infoContainer}>
              ...
              <View style={styles.infoItem}>
                ...
                <Text style={styles.infoValue}>280 kcal</Text>
              </View>
              <View style={styles.infoItem}>
          ...
          <View style={styles.imageContainer}>
            <Image 
              source={require('../../assets/recipes/fish.png')}
          ...
          <View style={styles.section}>
            ...
            <View style={styles.instructionsList}>
              {[
                'Clean and cut the fish into medium-sized pieces. Marinate with turmeric and salt for 10 minutes.',
                'Heat oil in a large pan. Add onions and sauté until golden brown.',
                ...
                'Carefully add fish pieces and cook for 5-7 minutes until fish is cooked through.',
          ...
          <View style={styles.nutritionSection}>
            ...
            <View style={styles.nutritionContent}>
              <View style={styles.calorieBox}>
                <Text style={styles.calorieNumber}>280</Text>
                ...
                <View style={styles.nutritionRow}>
                  <View style={styles.macroItem}>
                    ...
                    <View style={styles.macroTextContainer}>
                      ...
                      <Text style={styles.macroValue}>16g</Text>
                    </View>
                  </View>
                  <View style={styles.macroItem}>
                    <View style={styles.macroIconContainer}>
